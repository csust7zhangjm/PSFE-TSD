...
def extract_CAM(method, model: torch.nn.Module, predicted_bbox, classes, backward_per_class: bool, image, layer: int,
    ...
    target_layers = [model.model.model[24]]  #._modules['m']._modules['2']._modules['cv4']._modules['act']
...
def parseopt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/without2/weights/best.pt', help='model path or triton URL')   #runs/train/exp2/weights/best.pt
    parser.add_argument('--source', type=str, default= '/root/autodl-tmp/GTSDB/images/test/00011.jpg', help='file/dir/URL/glob/screen/0(webcam)')
